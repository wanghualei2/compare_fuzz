...
static void write_stats_file(double bitmap_cvg, double stability, double eps) {
  ...
  fprintf(f, "start_time        : %llu\n"
             ...
             exec_tmout, use_banner, stage_finds[STAGE_FLIP1],stage_cycles[STAGE_FLIP1],stage_finds[STAGE_FLIP2],stage_cycles[STAGE_FLIP2],stage_finds[STAGE_FLIP4],stage_cycles[STAGE_FLIP4],(stage_finds[STAGE_FLIP1]+stage_finds[STAGE_FLIP2]+stage_finds[STAGE_FLIP4])*1.0/(stage_cycles[STAGE_FLIP1]+stage_cycles[STAGE_FLIP2]+stage_cycles[STAGE_FLIP4]),
