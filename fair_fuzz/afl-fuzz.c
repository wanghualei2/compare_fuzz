...
static void write_stats_file(double bitmap_cvg, double stability, double eps) {
  ...
  fprintf(f, "start_time        : %llu\n"
             ...
             //以下为添加的代码
             "bit flips         :%lu:%lu , %lu:%lu , %lu:%lu\t---\t%f\n"
             "byte flips        :%lu:%lu , %lu:%lu , %lu:%lu\t---\t%f\n"
             "arithmetics       :%lu:%lu , %lu:%lu , %lu:%lu\t---\t%f\n"
             "known ints        :%lu:%lu , %lu:%lu , %lu:%lu\t---\t%f\n"           
             //以上为添加的代码
             //
             "command_line      : %s\n",
             ...
             stage_finds[STAGE_FLIP1],stage_cycles[STAGE_FLIP1],stage_finds[STAGE_FLIP2],stage_cycles[STAGE_FLIP2],stage_finds[STAGE_FLIP4],stage_cycles[STAGE_FLIP4],(stage_finds[STAGE_FLIP1]+stage_finds[STAGE_FLIP2]+stage_finds[STAGE_FLIP4])*1.0/(stage_cycles[STAGE_FLIP1]+stage_cycles[STAGE_FLIP2]+stage_cycles[STAGE_FLIP4]),
             stage_finds[STAGE_FLIP8],stage_cycles[STAGE_FLIP8],stage_finds[STAGE_FLIP16],stage_cycles[STAGE_FLIP16],stage_finds[STAGE_FLIP32],stage_cycles[STAGE_FLIP32],(stage_finds[STAGE_FLIP8]+stage_finds[STAGE_FLIP16]+stage_finds[STAGE_FLIP32])*1.0/(stage_cycles[STAGE_FLIP8]+stage_cycles[STAGE_FLIP16]+stage_cycles[STAGE_FLIP32]),
             stage_finds[STAGE_ARITH8],stage_cycles[STAGE_ARITH8],stage_finds[STAGE_ARITH16],stage_cycles[STAGE_ARITH16],stage_finds[STAGE_ARITH32],stage_cycles[STAGE_ARITH32],(stage_finds[STAGE_ARITH8]+stage_finds[STAGE_ARITH16]+stage_finds[STAGE_ARITH32])*1.0/(stage_cycles[STAGE_ARITH8]+stage_cycles[STAGE_ARITH16]+stage_cycles[STAGE_ARITH32]),
             stage_finds[STAGE_INTEREST8],stage_cycles[STAGE_INTEREST8],stage_finds[STAGE_INTEREST16],stage_cycles[STAGE_INTEREST16],stage_finds[STAGE_INTEREST32],stage_cycles[STAGE_INTEREST32],(stage_finds[STAGE_INTEREST8]+stage_finds[STAGE_INTEREST16]+stage_finds[STAGE_INTEREST32])*1.0/(stage_cycles[STAGE_INTEREST8]+stage_cycles[STAGE_INTEREST16]+stage_cycles[STAGE_INTEREST32]),
// STAGE_INTEREST8
             orig_cmdline);
             /* ignore errors */
